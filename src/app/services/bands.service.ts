...
export class BandsService {
  ...
  //       },
  //     ],
  //     video:"https://www.youtube.com/embed/rY0WxgSXdEE"
  //   },
  //   {
  //     id: 4,
  //     name: 'Pink Floyd',
  ...
  //       },
  //     ],
  //     video:"https://www.youtube.com/embed/IXdNnw99-Ic"
  //   },
  //   {
  //     id: 5,
  //     name: 'Deep Purple',
  ...
  //       },
  //     ],
  //     video:"https://www.youtube.com/embed/OorZcOzNcgE"
  //   },
  //   {
  //     id: 6,
  //     name: 'AC/DC',
  ...
  //       },
  //     ],
  //     video:"https://www.youtube.com/embed/A0Sc2CLqEmk"
  //   },
  //   {
  //     id: 7,
  //     name: 'The Ramones',
  ...
  //       },
  //     ],
  //     video:"https://www.youtube.com/embed/bm51ihfi1p4"
  //   },
  //   {
  //     id: 8,
  //     name: 'Kiss',
  ...
  public getBands(): Observable<BandModel[]> {
    return this._http.get<Array<BandModel>>('api/bands');
  }

  public getBandById(id: number): Observable<BandModel> {
    return this._http.get<BandModel>(`api/bands/${id}`);
  }

  public addBand(band: BandModel): Observable<BandModel> {
    return this._http.post<BandModel>(`api/bands`, band);
  }

  public updateBand(band: BandModel): Observable<BandModel> {
    return this._http.patch<BandModel>(`api/bands/${band?.id}`, band);
  }
